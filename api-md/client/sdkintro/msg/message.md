...
| content      | [MessageContent](#messagecontent)   | Message content, related to the contentType property. For example, when contentType is `jg:text`, content is a [text message](.././text) | 1.0.0 |
...
| content      | JMessageContent   | Message content, related to the contentType property. For example, when contentType is `jg:text`, content is a [text message](.././text) | 1.0.0 |
...
| content          | Object    | Message content, related to the name property. For example, when name is `jg:text`, content is a [text message](.././text) | 1.0.0    |
| sentState        | Number    | Message [sending state](../../enum/web#msg_sent)    | 1.0.0    |
...
| sender.id        | String    | Sender's ID. [Use API to update](../../../../server/user/updateuser/) | 1.0.0    |
| sender.name      | String    | Sender's name. [Use API to update](../../../../server/user/updateuser/) | 1.0.0    |
| sender.portrait  | String    | Sender's avatar. [Use API to update](../../../../server/user/updateuser/) | 1.0.0    |
| sender.exts      | Object    | User extension fields. [Use API to update](../../../../server/user/updateuser/) | 1.0.0    |
| attribute        | String    | Effective in `Electron`, local message extension attribute, e.g., storing local file URLs. Can be modified via [Update Local Message Extension](../../message/operator/update_lc_attr) | 1.0.0    |
| reactions        | Object    | Message reactions                                     | 1.8.0    |
| mentionInfo      | Object    | @ mention information                                | 1.0.0    |
| mentionInfo.mentionType      | Number    | @ all or @ specific users. See [MentionType](../../enum/web/#mention) for enum values | 1.0.0    |
...
| referMsg         | Object    | Referenced or replied message content, including sender information. See [Message](./) object for details | 1.0.0    |
| isMass           | Boolean   | Whether the message is a [mass message](../../message/msg_send/send_mass) | 1.0.0    |
...
| contentType  | string          | Message type (e.g., text message, image message)             | 1.0.0 |
| content      | MessageContent   | Message content, related to the contentType property. For example, when contentType is `jg:text`, content is a [text message](.././text) | 1.0.0 |
| messageId    | string          | Message ID, a globally unique identifier for each message    | 1.0.0 |
